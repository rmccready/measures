function () {
  ...
  */
  ...
  var exclusion = function () {
    ...
    var allergy_exclusions = actionFollowingSomething(measure.ace_inhibitor_or_arb_medication_allergy, allEncounters) + actionFollowingSomething(measure.ace_inhibitor_or_arb_medication_intolerance, allEncounters) + actionFollowingSomething(measure.ace_inhibitor_or_arb_medication_adverse_event, allEncounters);
