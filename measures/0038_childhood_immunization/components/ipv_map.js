function () {
  ...
  var numerator = function() {
    number_ipv_vaccine_administered = inRange(measure.ipv_medication_administered,
  ...
  var exclusion = function() {
    return ((inRange(measure.ipv_medication_allergy,  patient.birthdate, effective_date))
             ||
            (inRange(measure.neomycin_medication_allergy,     patient.birthdate, effective_date))
             ||
            (inRange(measure.streptomycin_medication_allergy, patient.birthdate, effective_date))
             ||
            (inRange(measure.polymyxin_medication_allergy,    patient.birthdate, effective_date)));
  }
