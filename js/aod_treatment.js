...
(function () {
    ...
    root.alcoholDrugFirstEvent = function (measure, effective_date) {
        ...
        encounters = normalize(inpatient_encounters, measure.encounter_ed_encounter, measure.encounter_outpatient_bh_encounter);
        diagnoses_during_encounters = allDiagnosesDuringEncounter(
        measure.alcohol_or_drug_dependence_diagnosis_active, encounters, earliest_diagnosis, latest_diagnosis);
        rehab_and_detox_during_inpatient_encounters = allEventsDuringEncounter(
        measure.alcohol_drug_rehab_and_detox_interventions_procedure_performed, inpatient_encounters, earliest_diagnosis, latest_diagnosis);
